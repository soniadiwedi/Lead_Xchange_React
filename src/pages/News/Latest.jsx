			...
			<div className="row">
				<div className="col-md-6">
					...
					<div className="fireside-main d-flex">
						...
						<h4>The importance of digital transformation continues to be one of the most important priorities </h4>
               ...
               <div class="col-md-12 ">
                  ...
                  <div class="row">
                     <div class="col-md-4 col-sm-12 ">
                        <div class="latest-article aos-init aos-animate" data-aos="zoom-in-down">
                           <img src={list1}/>
